...
export default function App() {
  ...
  const cohortData = useMemo(() => calculateCohortMatrix(filteredCustomers), [filteredCustomers]);
  const lifetimeStats = useMemo(() => calculateCustomerLifetimeStats(filteredCustomers), [filteredCustomers]);
  const churnStats = useMemo(() => calculateChurnStats(filteredCustomers, earlyChurnMonths), [filteredCustomers, earlyChurnMonths]);
  const tierAnalysis = useMemo(() => analyzeTierMetrics(filteredCustomers), [filteredCustomers]);
